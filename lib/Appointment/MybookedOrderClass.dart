                              ...
                              return InkWell(
                                onTap: () {
                                  Navigator.of(context).push(
                                      new MaterialPageRoute(builder: (_) => new CommonDashBord("order_dtl", true, _list[index].data)));
                                  /*
                    ...
                    children: [
                      ...
                      Expanded(
                        child: new Column(
                          ...
                          children: [
                            Text(
                              _list[index].data["line_items"][0]["name"].toString(),
                            ...
                            Text(
                              "Order at : " + GlobalWidget.ConvertDate(_list[index].data["date_created"]),
