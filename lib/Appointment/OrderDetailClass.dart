    ...
    return new Scaffold(
      ...
      body: new ListView(
        ...
        children: [
              ...
              children: [
                Expanded(
                  child: new Column(
                    ...
                    children: [
                      Text(
                        widget.data["line_items"][0]["name"].toString(),
                      ...
                      new Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              widget.data["currency"] + " " + widget.data["total"],
                              style: TextStyle(color: GlobalConstant.getTextColorDark(), fontSize: 14.0),
                      ...
                      new Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              GlobalWidget.ConvertDate(widget.data["date_created"]),
                              style: TextStyle(color: GlobalConstant.getTextColorDark(), fontSize: 14.0),
                              textAlign: TextAlign.end,
                            ),
                          )
          ...
          Sereverdata != null
              ? billingInfo(AppLocalizations.of(context).translate("st_date"), GlobalConstant.get_Dateval(Sereverdata[0]["start"]))
              : new Container(),
          Sereverdata != null
              ? billingInfo(AppLocalizations.of(context).translate("st_time"), GlobalConstant.readTimestamp(Sereverdata[0]["start"]))
              : new Container(),
          ...
          children: [
            Expanded(
              ...
              child: new Container(
                ...
                height: 60,
                width: 60,
                decoration: BoxDecoration(color: GlobalConstant.getTextColor(), shape: BoxShape.circle),
              ),
            ),
            Expanded(
              flex: 8,
              child: new Column(
                ...
                children: [
                  ...
                  Text(
                    widget.data['line_items'][index]["name"],
