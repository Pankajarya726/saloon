            ...
            children: [
             ...
             new Container(
               ...
               child:  HtmlEditor(
                 ...
                 value: widget.id.toString() != "0"
                     ? "${data == null ? "" : data['description'] == null ? "" : data['description']}"
                     : "",
                 key: keyEditor,
...
*/
              ...
              new Container(
                height: 200,
                child:  HtmlEditor(
                  hint: AppLocalizations.of(context).translate("srt_des").toString(),
                  value:widget.id.toString()!="0"?
                  "${data == null ? "" : data['short_description'] == null ? "" : data['short_description']}":"",
...
*/
              ...
              new Row(
                children: [
                  Expanded(
                    flex: 1,
                    child: GlobalConstant.getDurationString(
              ...
              new Row(
                children: [
                  Expanded(
                    flex: 1,
                    child: GlobalConstant.getDurationString(
                        AppLocalizations.of(context).translate("PaddingTime")),
                  ),
                  Expanded(
                    flex: 1,
              ...
              new Row(
                children: [
                  Expanded(
                    flex: 1,
                    child: getCancelCheck(),
                  ),
                  Expanded(
                    flex: 9,
                    child: GlobalConstant.getDurationStringText(
                        AppLocalizations.of(context)
                            .translate("canbecanceltext")),
                  ),
                ],
              ),
    ...
    if (await NetworkCheck.check()) {
      ...
      apiController.GetWithMyToken(context,Url, token).then((value) {
        try {
          ...
          InitDescipt = "${data['description'].toString()}";
          Utility.log(TAG + "des", InitDescipt);
          srt_desController.text = data['short_description'];
          Category_Id = data['categories'].length > 0 ? data['categories'][0]['id'].toString() : "";
          categoryController.text = data['categories'].length>0?data['categories'][0]['name'].toString():"";
          List l1 = data['images'];
          for (int i = 0; i < l1.length; i++) {
            _list.add(l1[i]['src']);
          }
          setState(() {
            print(widget.id + 'id'+"${data['short_description']}");
            keyEditor.currentState.setText(data["description"]);
            keyEditor_short_des.currentState.setText(data['short_description']);
          });
        } catch (e) {
          print("exception-->$e");
        }
  ...
  void GetDataNew() async {
    String token =
        (await Utility.getStringPreference(GlobalConstant.admin_token));
    String Url =
        "https://api.smartdatasystem.es/v1/sensors?apiKey=5ad97dec969a5d8c6f87d647601828bafebf1208f13d78e5c060ad4c3595a293";
    ApiController apiController = new ApiController.internal();
  ...
  GetBackToHome() {
    return new Container(
      ...
      child: FlatButton(
        ...
        child: Text(
          AppLocalizations.of(context).translate("back_shop"),
  ...
  ProductName() {
    return TextFormField(
      ...
      decoration: GlobalWidget.TextFeildDecoration(
          AppLocalizations.of(context).translate("pro_name")),
      validator: (value) {
        if (value.isEmpty) {
  ...
  _toggle1() {
    Navigator.of(context)
        .push(
      new MaterialPageRoute(builder: (_) => new SearchCategory()),
    )
        .then((val) {
  ...
  void SubmitData() async {
    ...
    await keyEditor_short_des.currentState.getText();
    final description_text_data = await keyEditor.currentState.getText();
    final  srt_description_text_data = await keyEditor_short_des.currentState.getText();
    ...
    Map<String, String> mapobj_data2() => {
          'src':
    ...
    Map<String, String> meta_data21() =>
        {'_wc_appointment_duration_unit': durationString};
    Map<String, String> meta_data22() =>
        {'_wc_appointment_duration': durationInt};
    Map<String, String> meta_data23() =>
        {'_wc_appointment_interval_unit': IntervalString};
    Map<String, String> meta_data24() =>
        {'_wc_appointment_interval': IntervalInt};
    Map<String, String> meta_data25() =>
        {'_wc_appointment_padding_duration_unit': PaddingTimeString};
    Map<String, String> meta_data26() =>
        {'_wc_appointment_padding_duration': PaddingTimeInt};
    Map<String, String> meta_data27() =>
        {'_wc_appointment_min_date_unit': "day"};
    Map<String, String> meta_data28() => {'_wc_appointment_min_date': "0"};
    Map<String, String> meta_data29() =>
        {'_wc_appointment_max_date_unit': "month"};
    Map<String, String> meta_data30() => {'_wc_appointment_max_date': "12"};
    Map<String, String> meta_data31() =>
        {'_wc_appointment_user_can_cancel': ""};
    Map<String, String> meta_data32() =>
        {'_wc_appointment_cancel_limit_unit': CancelString};
    Map<String, String> meta_data33() =>
        {'_wc_appointment_cancel_limit': CancelInt};
    Map<String, String> meta_data34() =>
        {'_wc_appointment_requires_confirmation': ""};
    Map<String, String> meta_data35() =>
        {'_wc_appointment_customer_timezones': "1"};
    Map<String, String> meta_data36() =>
        {'_wc_appointment_cal_color': "#0073aa"};
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      ...
                      image: new NetworkImage(_list[index]),
                      fit: BoxFit.fill)),
            );
          }),
    );
  ...
  getDurationString() {
    return new Theme(
        ...
        child: DropdownButton<String>(
          ...
          items:
              durationStringItems.map<DropdownMenuItem<String>>((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
  ...
  getIntervalString() {
    return new Theme(
        ...
        child: DropdownButton<String>(
          ...
          items:
              IntervalStringItems.map<DropdownMenuItem<String>>((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
  ...
  getPaddingTimeInt() {
    return new Theme(
        ...
        child: DropdownButton<String>(
          ...
          items:
              PaddingTimeIntItems.map<DropdownMenuItem<String>>((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
  ...
  getPaddingTimeString() {
    return new Theme(
        ...
        child: DropdownButton<String>(
          ...
          items: PaddingTimeStringItems.map<DropdownMenuItem<String>>(
              (String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
  ...
  getCancelString() {
    return new Theme(
        ...
        child: DropdownButton<String>(
          ...
          items:
              CancelStringItems.map<DropdownMenuItem<String>>((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
