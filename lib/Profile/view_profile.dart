...
*/
  ...
  getStoreview() {
    return ExpansionTile(
      ...
      children: <Widget>[
        profile['meta']['_store_description'] != null
            ? new Container(padding: EdgeInsets.all(10.0), child: Text(parse(profile['meta']['_store_description'][0]).body.text)
          /* Html(
  ...
  getPolicyview() {
    return ExpansionTile(
        ...
        children: <Widget>[
    profile['meta']['wcfm_policy_vendor_options'] != null
    ? new Container(
        padding: EdgeInsets.all(10.0),
    child: Text(parse(profile['meta']['wcfm_policy_vendor_options'][0]).body.text)/*Html(
...
*/
  ...
  void openOtherProfile() {
    Navigator.of(context)
        .push(
      new MaterialPageRoute(builder: (_) => new CommonDashBord("edit_oth", true)),
    )
        .then((val) {
      FocusScope.of(context).requestFocus(new FocusNode());
      if (val != null) {
